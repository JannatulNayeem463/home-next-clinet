...
const NotFound = () => {
  return (
    <div className="notfound-container bg-linear-to-br from-purple-700 via-indigo-800 to-blue-900 text-white flex flex-col items-center justify-center h-screen">
